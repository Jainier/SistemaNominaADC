...
{
    /// <inheritdoc />
    public partial class AgregarEstadoARoles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdEmpleado = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdGrupoEstado = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrupoEstado", x => x.IdGrupoEstado);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departamento_Estado_IdEstado",
                        column: x => x.IdEstado,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrupoEstadoDetalle", x => new { x.IdGrupoEstado, x.IdEstado });
                    table.ForeignKey(
                        name: "FK_GrupoEstadoDetalle_Estado_IdEstado",
                        column: x => x.IdEstado,
                        principalTable: "Estado",
                        principalColumn: "IdEstado",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GrupoEstadoDetalle_GrupoEstado_IdGrupoEstado",
                        column: x => x.IdGrupoEstado,
                        principalTable: "GrupoEstado",
                        principalColumn: "IdGrupoEstado",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjetoSistema", x => x.IdObjeto);
                    table.ForeignKey(
                        name: "FK_ObjetoSistema_GrupoEstado_IdGrupoEstado",
                        column: x => x.IdGrupoEstado,
                        principalTable: "GrupoEstado",
                        principalColumn: "IdGrupoEstado",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empleado_Puesto_IdPuesto",
                        column: x => x.IdPuesto,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GrupoEstadoDetalle_IdEstado",
                table: "GrupoEstadoDetalle",
                column: "IdEstado");

            migrationBuilder.CreateIndex(
                name: "IX_ObjetoSistema_IdGrupoEstado",
                table: "ObjetoSistema",

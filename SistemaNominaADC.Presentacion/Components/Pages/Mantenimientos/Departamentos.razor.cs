...
namespace SistemaNominaADC.Presentacion.Components.Pages.Mantenimientos
{
    public partial class Departamentos
    {
        ...
        private void Editar(Departamento item)
        {
            ...
            tituloFormulario = "Editar Departamento";
            mostrarFormulario = true;
        }
        ...
        // Acción: Botón "Eliminar" del formulario
        private async Task Eliminar()
        {
            if (departamentoActual == null || departamentoActual.IdDepartamento <= 0)
                return;

            var resultado = await DepartamentoCliente.Eliminar(departamentoActual.IdDepartamento);

...
public partial class TipoPermisos
{
    ...
    private void Crear() { tipoActual = new TipoPermiso { ConGoceSalarial = true }; tituloFormulario = "Nuevo Tipo de Permiso"; mostrarFormulario = true; }
    private void Editar(TipoPermiso item) { tipoActual = new TipoPermiso { IdTipoPermiso = item.IdTipoPermiso, Nombre = item.Nombre, ConGoceSalarial = item.ConGoceSalarial, IdEstado = item.IdEstado }; tituloFormulario = "Editar Tipo de Permiso"; mostrarFormulario = true; }

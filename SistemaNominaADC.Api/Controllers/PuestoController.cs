...
public class PuestoController : ControllerBase
{
    ...
    public PuestoController(IPuestoService service, IObjetoSistemaAuthorizationService objetoAuthService)
    {
        _service = service;
    ...
    {
        var autorizado = await _objetoAuthService.PuedeAccederModuloAsync(User, "Puesto");
